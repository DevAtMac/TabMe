...
namespace TabMe.DAL
{
    public class PictureBase
    {
        ...
        public static List<Picture> GetByEntityType_Id(int EntityType, int EntityId)
        {
            DatabaseHelper oDatabaseHelper = new DatabaseHelper();
            bool ExecutionState = false;
            ...
            IDataReader dr = oDatabaseHelper.ExecuteReader("Picture_GetByEntityType_Id", ref ExecutionState);

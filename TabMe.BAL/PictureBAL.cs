...
namespace TabMe.BAL
{
    public class PictureBAL
    {
        ...
        public static List<PictureViewModel> GetByEntityType_Id(int EntityType, int EntityId)
        {
            var pictures = Picture.FixBack(Picture.GetByEntityType_Id(EntityType, EntityId));
            return pictures;
        }
    }
}
